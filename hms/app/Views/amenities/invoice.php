					...
					<div class="card">
						<div class="card-body m-sm-3 m-md-5">					
									...
									<?php foreach ($orders_data as $value): ?>			
										<tr>
											<td>
												...
												<?php foreach ($amenities as $fd): ?>
													<?php if( $value['item_id'] == $fd['amenities_id']): ?>
														<?= $fd['amenities_name']; ?>
													<?php endif; ?>
												<?php endforeach ?>	
												<?php endif ?>		
											...
											<td class="text-end">
												...
												<?php foreach ($amenities as $fd): ?>
													<?php if( $value['item_id'] == $fd['amenities_id']): ?>
														<?= '₦'.number_format($fd['amenities_price']); ?>
													<?php endif; ?>
												<?php endforeach ?>
												<?php endif ?>
											</td>
							...
							<div class="text-center">
					            ...
					            <a href="<?= base_url() ?>/print_invoice/<?= $orders['bill_no'] ?>" class="btn btn-primary">
					              Print this Invoice
					            </a>
							</div>							
						</div>
