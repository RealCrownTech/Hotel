								...
								<div class="row">
									...
									<div class="col-12 col-xl-3">
										<div class="mb-3 mb-xl-0">
											<label class="form-label">Arrival Date<span class="font-13 text-danger">*</span></label>
											<input class="form-control" type="text" id="arrival_date" name="arrival_date" value="<?= set_value('arrival_date')  ?>" />
											<span class="text-danger"><?= display_error($validation, 'arrival_date') ?></span>
										</div>
									</div>
									<div class="col-12 col-xl-3">
										<div class="mb-3 mb-xl-0">
											<label class="form-label">Departure Date<span class="font-13 text-danger">*</span></label>
							...
							<div class="row">
								...
								<div class="col-12 mb-3 col-xl-4">
									<div class="mb-3 mb-xl-0">
										...
										<span class="text-danger"><?= display_error($validation, 'discount') ?></span>
									</div>
								</div>
								<div class="col-12 mb-3 col-xl-4">
									<div class="mb-3 mb-xl-0">
							...
							<div class="row">
								<div class="col-12 mb-3 col-xl-4">
									<div class="mb-3 mb-xl-0">
										...
										<input class="form-control" type="text" id="deposit_amount" onkeyup="DepAmount()" name="deposit_amount" required />
										<span class="text-danger"><?= display_error($validation, 'deposit_amount') ?></span>
									</div>
								</div>
								<div class="col-12 mb-3 col-xl-4">
									<div class="mb-3 mb-xl-0">
										<label class="form-label">Balance Amount</label>
										<input class="form-control" type="text" id="balance_amount" name="balance_amount" readonly />
									</div>
								</div>
								<div class="col-12 mb-3 col-xl-4">
									<div class="mb-3 mb-xl-0">
	...
	<script type="text/javascript">
		...
		function subAmount() {
			...
			if (parseFloat(discount) > parseFloat(gross_amount)) {
				...
				parseFloat($('#balance_amount').val(total_amount - deposit_amount));
			}
		}
		...
		function DepAmount() {
			...
			var deposit_amount = $('#deposit_amount').val();
			var balance_amount = total_amount - deposit_amount;
			if (parseFloat(deposit_amount) > parseFloat(total_amount)) {
				parseFloat($('#deposit_amount').val(total_amount));
				parseFloat($('#balance_amount').val(total_amount));
			}else{
				parseFloat($('#balance_amount').val(balance_amount));
				// parseFloat($('#balance_amount').val(total_amount));
			}
		}
	</script>
